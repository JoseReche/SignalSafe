...
draw_text(408,500,"Posição X: "+ string(global.bateuCarro))
draw_text(408,550,"Posição Y: "+ string(global.moedas))
draw_text(408,600,"Posição Xx: "+ string(global.passareala)) 
draw_text(408,650,"Posição Yy: "+ string(global.semafaro))
